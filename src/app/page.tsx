...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 selection:bg-green-500/30 selection:text-green-200">
      {/* Фоновые эффекты */}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { 
                icon: '🚁', 
                title: 'Умная охота', 
                desc: 'Дроны и AI для мониторинга дикой природы', 
              ...
              { 
                icon: '👁️', 
                title: 'AI Vision', 
                desc: 'Компьютерное зрение для анализа в реальном времени', 
              ...
              <motion.a
                key={feature.title}
                href={feature.href}
                className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-green-500/30 transition-all block"
                ...
                whileHover={{ y: -5 }}
              >
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-white text-2xl mb-4 shadow-lg`}>
                  {feature.icon}
                </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {['🌱 Экология', '🤖 AI/ML', '🚁 Дроны', '🧬 Биотех'].map((badge) => (
                  <span 
                    key={badge} 
                    className="px-4 py-2 rounded-lg bg-green-500/10 border border-green-500/30 text-green-400 text-sm font-medium"
                  >
                    {badge}
                  </span>
                ))}
